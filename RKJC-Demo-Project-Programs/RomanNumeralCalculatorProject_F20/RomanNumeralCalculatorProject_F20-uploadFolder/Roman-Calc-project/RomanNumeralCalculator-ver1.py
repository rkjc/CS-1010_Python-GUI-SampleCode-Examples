...
dispFrame1 = tk.LabelFrame(Frm3, text='Initus est numerus uno')
dispFrame2 = tk.LabelFrame(Frm3, text='Initus est numerus duo')
dispFrame3 = tk.LabelFrame(Frm3, text = 'Responsum')

#L1_inBox1 = tk.Label(Frm3, text = '', relief='sunken', width=34, height=2)
L2 = tk.Label(Frm3, text='Initus est numerus uno')
#L3_inBox2 = tk.Label(Frm3, text = '', relief='sunken', width=34, height=2)
L4 = tk.Label(Frm3, text='Initus est numerus duo')
L_answer = tk.Label(dispFrame3, text = '', relief='sunken', width=40, height=2)
#L6 = tk.Label(Frm3, text = 'Responsum')
inBox1 = tk.Button(dispFrame1,  command=changeInbox_1, relief='sunken', width=34, height=1 )
inBox2 = tk.Button(dispFrame2,  command=changeInbox_2, relief='sunken', width=34, height=1)

B_I = tk.Button(Frm1, text = 'I', command=B_I_push)
B_V = tk.Button(Frm1, text = 'V', command=B_V_push)
B_X = tk.Button(Frm1, text = 'X', command=B_X_push)
B_L = tk.Button(Frm1, text = 'L', command=B_L_push)
B_C = tk.Button(Frm1, text = 'C', command=B_C_push)
B_D = tk.Button(Frm1, text = 'D', command=B_D_push)
B_M = tk.Button(Frm1, text = 'M', command=B_M_push)
B_plus = tk.Button(Frm1, text = '+', command=addRN)
B_minus = tk.Button(Frm1, text = '-', command=subtractRN)
B_times = tk.Button(Frm1, text = '*', command=multiplyRN)
B_divide = tk.Button(Frm1, text = '/', command=divideRN)
del_button = tk.Button(Frm1, text=" delere", command=delRN)
clear = tk.Button(Frm1, text="a  c\nu  u\nf  n\ne  c\nr  t\no  u\n   s", width=2, height=6, command=clear)
#  C\nL\nE\nA\nR
# ======================================
inBox1.config(borderwidth=3)

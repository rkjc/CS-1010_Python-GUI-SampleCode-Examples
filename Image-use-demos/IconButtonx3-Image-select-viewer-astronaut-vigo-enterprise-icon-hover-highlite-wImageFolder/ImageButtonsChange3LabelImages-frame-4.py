...
img01 = tkinter.PhotoImage(file="images/Space_Woman_500.png")
img01_thumb = img01.subsample(4)

img02 = tkinter.PhotoImage(file="images/vigo_500.png")
img02_thumb = img02.subsample(4)

img03 = tkinter.PhotoImage(file="images/Enterprise_500.png")
